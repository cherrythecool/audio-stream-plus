#ifndef RESOURCE_FORMAT_LOADER_WAV_EXT_H
#define RESOURCE_FORMAT_LOADER_WAV_EXT_H
...
class ResourceFormatLoaderWavExt : public ResourceFormatLoader {
    GDCLASS(ResourceFormatLoaderWavExt, ResourceFormatLoader);
...
public:
    ...
    ResourceFormatLoaderWavExt();
	virtual ~ResourceFormatLoaderWavExt();
